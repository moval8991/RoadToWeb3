...
async function main() {
  ...
  if (contractBalance !== "0.0") {
    console.log(`withdrawing funds to address ${withdrawAddress}..`);
  ...
  console.log("balance of withdraw address after withdrawing: ", await getBalance(provider, withdrawAddress), "ETH");
}
